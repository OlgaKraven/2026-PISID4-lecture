...
const mainLiterature = [
  'Страуструп, Б. Язык программирования C++ для профессионалов : учебник / Б. Страуструп. — 4-е изд. — Москва : Интернет-Университет Информационных Технологий (ИНТУИТ), Ай Пи Ар Медиа, 2025. — 670 c. — ISBN 978-5-4497-0922-6. — Текст : электронный // Цифровой образовательный ресурс IPR SMART : [сайт]. — URL: https://www.iprbookshop.ru/146412.html',
  'Фридман, А. Л. Язык программирования C++ : учебное пособие / А. Л. Фридман. — 4-е изд. — Москва : Интернет-Университет Информационных Технологий (ИНТУИТ), Ай Пи Ар Медиа, 2025. — 217 c. — ISBN 978-5-4497-0920-2. — Текст : электронный // Цифровой образовательный ресурс IPR SMART : [сайт]. — URL: https://www.iprbookshop.ru/146411.html',
];
const additionalLiterature = [
  'Иванов, В. Б. Прикладное программирование на C/C++: с нуля до мультимедийных и сетевых приложений / В. Б. Иванов. — 2-е изд. — Москва : СОЛОН-Пресс, 2024. — 240 c. — ISBN 978-5-91359-474-7. — Текст : электронный // Цифровой образовательный ресурс IPR SMART : [сайт]. — URL: https://www.iprbookshop.ru/142013.html',
  'Чукич, И. Функциональное программирование на языке C++ / И. Чукич ; перевод В. Ю. Винник, А. Н. Киселев. — Москва : ДМК Пресс, 2020. — 360 c. — ISBN 978-5-97060-781-7. — Текст : электронный // Цифровой образовательный ресурс IPR SMART : [сайт]. — URL: https://www.iprbookshop.ru/124744.html',
];
...
function conceptSlides(topic: Topic, concept: Concept, index: number): Slide[] {
  ...
  return [
    ...
    },
    {
      ...
      compare: {
        leftTitle: 'Слабо',
        left: [`«Сделаем ${concept.name.toLowerCase()} как обычно»`, 'Нет источника и критерия проверки', 'Непонятно, кто принял решение'],
    ...
    },
    {
      ...
      eyebrow: 'МИКРОПРОВЕРКА', title: `Проверьте понимание: ${concept.name}`,
      quiz: {
